...
public class OrderTable extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            while(rs.next()){
            String no=rs.getString("Orderno");
            String nod=rs.getString("OrderDate");
            String nid=rs.getString("Item_Id");
            String ns=rs.getString("Shopper_Id");
            String nq=rs.getString("Quantity");
            String np=rs.getString("price");
            String ndi=rs.getString("Discount");
            String na=rs.getString("Amount");
            model.addRow(new Object[]{no,nod,nid,ns,nq,np,ndi,na});
            }
            }
            catch(Exception e){
