...
public class ItemTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Name", "Descirption", "Price"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            while(rs.next()){
            String nii=rs.getString("Item_Id");
            String nin=rs.getString("Item_Name");
            String nd=rs.getString("Description");
            String np=rs.getString("Price");
            model.addRow(new Object[]{nii,nin,nd,np});
            }
            }
            catch(Exception e){
